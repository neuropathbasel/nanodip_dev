...
versionString="49"                                   # version string of this application
...
f5cBin="export HDF5_PLUGIN_PATH="+userhome+"/.local/hdf5/lib/plugin; /applications/f5c_r10/f5c-v1.2/f5c" # f5c binary launch command
...
basecallWrapperScript="/applications/nanodip/dorado_basecaller_barcorder_call_one_fast5_07.sh"
...
thisDir="/data/nanodip_output/B2023_54565_20231213_R10_450MB_BC01_ND"
o=os.walk(thisDir)
for dName, sdName, fList in o:
    for fName in fList:
        if "methoverlapcount" in fName:
            print(fName)
