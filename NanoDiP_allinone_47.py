...
basecallWrapperScript="/applications/nanodip/dorado_basecaller_barcorder_call_one_fast5_03.sh"
...
def analysisLaunchTable(): # present a table from which analyses can be started in a post-hoc manner
    ...
    for r in range(len(allowedRunFolders)):
        ...
        if allowedRunFolders[r].endswith("_ND"): # has already been basecalled and barcoded by NanoDiP
            ...
            lt=lt+"<td><a href='./analysisLauncher?functionName=basecallPoller&sampleName="+allowedRunFolders[r]+"&basecallModel=dna_r9.4.1_e8_hac@v3.3&barcodeSet=SQK-RBK004' target='_blank' rel='noopener noreferrer' title='"+allowedRunFolders[r]+": basecall R9'>R9</a></td>"
            lt=lt+"<td><a href='./analysisLauncher?functionName=basecallPoller&sampleName="+allowedRunFolders[r]+"&basecallModel=dna_r10.4.1_e8.2_400bps_hac@v4.2.0&barcodeSet=SQK-RBK114-24' target='_blank' rel='noopener noreferrer' title='"+allowedRunFolders[r]+": basecall R10 400bps'>R10f</a></td>"
            lt=lt+"<td><a href='./analysisLauncher?functionName=basecallPoller&sampleName="+allowedRunFolders[r]+"&basecallModel=dna_r10.4.1_e8.2_260bps_hac@v4.1.0&barcodeSet=SQK-RBK114-24' target='_blank' rel='noopener noreferrer' title='"+allowedRunFolders[r]+": basecall R10 260bps'>R10s</a></td>"
